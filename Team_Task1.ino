  ...
  int p0 = 0; int p1= 1; int p2=2; int p3=3; int p4=4; int p5=5;  // analog pin used to connect the potentiometer
  int val01;  int val02;int val03; int val04; int val05; int val06;   // variable to read the value from the analog pin
  
  void setup() {
    servo01.attach(11); servo02.attach(10); servo03.attach(9);servo04.attach(6); servo05.attach(5); servo06.attach(3);// attaches the servo on pins to the servo object
  }
  ...
  void loop() {
    ...
    val06 = analogRead(p5);            // reads the value of the potentiometer (value between 0 and 1023)
    val06 = map(val06, 0, 1023, 0, 90);     // scale it to use it with the servo (value between 0 and 90)
    servo06.write(val06);                  // sets the servo position according to the scaled value
